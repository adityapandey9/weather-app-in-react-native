...
def climbingLeaderboard(scores, alice):
    ...
    for a in alice:
        ...
        while(l < h):
            mid = int((l+h)/2)
            # print("H: ", h , scores[h], " L: ", l, scores[l], " M: ", mid, scores[mid])
            if scores[mid] == a:
                # print("H: ", h , scores[h], " L: ", l, scores[l], " M: ", mid, scores[mid], " A: ", a)
                l = -1
                break
            if scores[mid] > a:
                l = mid + 1
                # print("H Change: ", scores[mid], a, mid, l)
            elif scores[mid] < a:
                h = mid - 1
            # print("H: ", h, " L: ", l)
        # print("Mid: ", mid, l, h, a)
